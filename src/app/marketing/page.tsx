...
export default function MarketingDApp() {
    ...
    <main className="min-h-screen p-6 md:p-12 bg-base-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-primary">Real Autonomous Marketing</h1>
          <p className="text-xl text-base-content opacity-80 max-w-2xl mx-auto">
            Launch your AI-powered marketing campaign by providing your parameters and assets below.
          </p>
        </div>
        ...
        {isSuccess ? (
          <div className="bg-success/10 border border-success rounded-lg p-8 text-center">
            ...
            <h2 className="text-2xl font-bold mb-4">Campaign Launched Successfully!</h2>
            <p className="mb-6">Your autonomous marketing campaign is now being processed. You'll receive updates via email.</p>
          ...
          <form onSubmit={handleSubmit} className="bg-base-200 rounded-lg p-6 md:p-8 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-medium">Campaign Duration</span>
                </label>
                <input
                  type="text"
              ...
              <div className="form-control md:col-span-2">
                <label className="label">
                  ...
                  <span className="label-text-alt">Brand assets, logos, guidelines, etc.</span>
                </label>
